        ...
        DB::transaction(function () use ($siswaList, $validated) {
            foreach ($siswaList as $siswa) {
                Alumni::create([
                    ...
                    // Snapshot hash password & kelas — dipakai HANYA jika
                    // admin membatalkan status alumni ini di kemudian hari.
                ...
                // Hapus permanen baris siswa terlebih dahulu (anak),
                // baru baris user (induk) — supaya tidak menabrak FK.
                $siswa->delete();
