...
║                                                                             ║
║  Fix: Hapus filter tanggal_selesai agar semua pengumuman aktif tampil,      ║
║  sama seperti tampilan siswa. Pengumuman kadaluarsa diberi badge khusus.    ║
╚══════════════════════════════════════════════════════════════════════════════╝
--}}
                ...
                <button type="button"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-start justify-between gap-3 mb-1.5">
                                <div class="flex items-center gap-2 flex-1 min-w-0 flex-wrap">
                                    <h3 class="font-bold text-slate-800 dark:text-slate-100 text-[15px] leading-snug
                                               ...
                                               transition-colors {{ $isExpired ? 'line-through decoration-slate-400' : '' }}">
                                        {{ $item->judul }}
                                    </h3>
                                    @if($isNew && !$isExpired)
                            ...
                            {{-- Badge tanggal berakhir (hanya tampil jika BELUM kadaluarsa & belum segera berakhir) --}}
                            @if($item->tanggal_selesai && !$segBerakhir && !$isExpired)
                            ...
                            {{-- Badge khusus jika sudah kadaluarsa --}}
                            @if($isExpired)
                            <div class="mt-2.5 inline-flex items-center gap-1.5 text-[11px] font-medium
