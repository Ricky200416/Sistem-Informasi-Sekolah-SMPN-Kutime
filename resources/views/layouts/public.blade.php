        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <div class="font-lora font-bold text-white text-base leading-tight">{{ $singkatan }}</div>
                        <div class="text-xs" style="color:#94a3b8;font-size:.7rem">{{ $namaSekolah }}</div>
                    </div>
                </div>
                <p class="text-sm leading-relaxed" style="color:#6b7fa8;max-width:220px">{{ $taglineFooter }}</p>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm" style="color:#6b7fa8">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <span class="leading-relaxed">{{ $kontakFooter->kontak_alamat }}</span>
                    </li>
                    @endif
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/','',$kontakFooter->kontak_telepon) }}" class="footer-link">{{ $kontakFooter->kontak_telepon }}</a>
                    </li>
                    @else
                    <li class="flex items-center gap-3">
                        <svg class="w-4 h-4 shrink-0" style="color:#c8a84b" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:{{ $kontakFooter->kontak_email }}" class="footer-link">{{ $kontakFooter->kontak_email }}</a>
                    </li>
                    @endif
                </ul>
            </div>
