...
<div class="stat-bar">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <?php if($st['val']): ?>
            <div class="stat-item">
                <div class="text-xl mb-1"><?php echo e($st['icon']); ?></div>
                <div class="font-lora font-bold text-white" style="font-size:1.25rem;line-height:1.1"><?php echo e($st['val']); ?></div>
                <div class="text-xs mt-0.5" style="color:rgba(255,255,255,.52);font-size:.72rem"><?php echo e($st['label']); ?></div>
            </div>
            <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center gap-3">
        ...
        <div class="overflow-hidden flex-1"
            ...
            <p class="ticker-run text-sm font-medium" style="color:#374151">
                ...
                <?php if($infoPpdb): ?> 📋 PPDB: <?php echo e(Str::limit(strip_tags($infoPpdb), 150)); ?> <?php endif; ?>
            </p>
        </div>
    </div>
</div>
...
<section style="background:var(--cream)" class="py-12 lg:py-16" id="tentang">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="sec-head">
            ...
            <h2>Tentang <?php echo e(\App\Models\SchoolSetting::get('singkatan','SMPN Kutime')); ?></h2>
...
<section class="bg-white py-12 lg:py-16" id="fasilitas">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
            ...
            <div class="fasil" style="background:<?php echo e($f['bg']); ?>;border-color:<?php echo e($f['bdr']); ?>">
                <div class="text-4xl mb-3"><?php echo e($f['emoji']); ?></div>
                <h4 class="font-bold text-slate-800 text-sm mb-2"><?php echo e($f['label']); ?></h4>
            ...
            <div class="card p-6 sm:p-7 text-white relative overflow-hidden"
                ...
                <div class="flex items-center gap-3 mb-5 relative z-10">
                    ...
                    <img src="<?php echo e(asset('storage/'.$sambFoto)); ?>"
                         ...
                         style="border-color:rgba(200,168,75,.50)" alt="<?php echo e($sambNama); ?>">
                    <?php else: ?>
                    ...
                    <div>
                        <?php if($sambNama): ?>
                        <p class="font-bold text-white text-base leading-tight"><?php echo e($sambNama); ?></p>
                        <?php endif; ?>
                        <p class="text-sm font-semibold mt-0.5" style="color:var(--gold2)"><?php echo e($sambJabatan); ?></p>
                    </div>
                </div>
                ...
                <div class="flex flex-col flex-1 p-5">
                    ...
                    <div class="flex items-center gap-1.5 mb-3 flex-wrap">
                        ...
                        <span class="px-2 py-0.5 rounded-full font-semibold"
                              style="background:#eff6ff;color:#1d4ed8;font-size:.7rem"><?php echo e($b->kategori); ?></span>
                        <?php endif; ?>
                        <?php if($b->media_tipe && $b->media_tipe !== 'none'): ?>
                            ...
                            ?>
                            <span class="px-2 py-0.5 rounded-full font-medium <?php echo e($badge[0]); ?>" style="font-size:.7rem">
                                <?php echo e($badge[1]); ?>

                            </span>
                        <?php endif; ?>
                        <span class="ml-auto" style="color:#94a3b8;font-size:.72rem"><?php echo e($b->created_at->diffForHumans()); ?></span>
                    </div>

                    
                    <h3 class="berita-judul mb-2"><?php echo e($b->judul); ?></h3>

                    
                    <?php if($b->ringkasan || $b->isi): ?>
                    <p class="berita-snippet mb-3">
                        <?php echo e(Str::limit(strip_tags($b->ringkasan ?? $b->isi), 120)); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            ...
            <a href="<?php echo e(route('website.galeri')); ?>" class="g-item">
                ...
                <div class="g-cap">
                    <p class="text-white text-xs font-semibold leading-snug lc2"><?php echo e($g->judul); ?></p>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
            ...
            <div class="space-y-3">
                ...
                <div class="card flex gap-4 p-5">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-700 leading-relaxed"><?php echo e($kontakRow->kontak_alamat); ?></p>
                    </div>
                </div>
                <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH S:\PA3\smpn-kutime\resources\views/website/home.blade.php ENDPATH**/ ?>