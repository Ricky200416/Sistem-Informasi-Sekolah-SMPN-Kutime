        ...
        <div class="overflow-x-auto">
            <table>
                ...
                <tbody>
                    ...
                    <tr data-alumni-id="<?php echo e($a->id); ?>">
                        ...
                        <td>
                            <?php if($a->is_editable): ?>
                                <span class="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[10px] font-semibold
                                             bg-amber-50 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400"
                                      title="Bisa diedit hingga <?php echo e($a->edit_deadline->translatedFormat('d M Y, H:i')); ?>">
                                    <i class="bi bi-pencil-square"></i> <?php echo e($a->edit_time_left_label); ?> lagi
                                </span>
                            <?php else: ?>
                                <span class="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[10px] font-semibold
                        ...
                        <td>
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <?php if($a->is_editable): ?>
                                <button onclick="openEditAlumni(<?php echo e($a->id); ?>)"
...
<?php echo $__env->make('admin.alumni._modal_edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
function openEditAlumni(id) {
    fetch(`<?php echo e(url('admin/alumni')); ?>/${id}/edit`, {
        headers: { 'Accept': 'application/json', 'X-Requested-With': 'XMLHttpRequest' }
    })
    .then(async r => {
...
function buildAlumniEditModal(a) {
    ...
    document.getElementById('formEditAlumni').action = `<?php echo e(url('admin/alumni')); ?>/${a.id}`;
}
...
function loadSiswaAktif() {
    ...
    fetch(`<?php echo e(route('admin.alumni.siswa-aktif')); ?>`, { headers: { 'Accept': 'application/json' } })
        .then(r => r.json())
        .then(data => {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PROJECT\smpn-kutime\resources\views/admin/alumni/index.blade.php ENDPATH**/ ?>