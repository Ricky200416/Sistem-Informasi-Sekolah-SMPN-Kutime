...
<body>
    ...
    <div class="page-header">
        <div class="header-inner">
            ...
            <div class="header-meta">
                ...
                <div class="header-badge"><?php echo e($users->count()); ?> Guru Terdaftar</div>
            </div>
        </div>
    </div>
    ...
    <div class="summary-bar">
        ...
        <div class="summary-item">
            <div class="summary-number"><?php echo e($totalPns); ?></div>
            <div class="summary-label">PNS</div>
        </div>
        <div class="summary-divider"></div>
        <div class="summary-item">
            <div class="summary-number"><?php echo e($totalPppk); ?></div>
            <div class="summary-label">PPPK</div>
        </div>
        <div class="summary-divider"></div>
        <div class="summary-item">
            <div class="summary-number"><?php echo e($totalHonorer); ?></div>
            ...
            <tbody>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="td-nama"><?php echo e($g?->nama ?? $user->name); ?></div>
                            <div class="td-email"><?php echo e($user->email); ?></div>
                        </td>

                        
                        <td class="td-mono"><?php echo e($g?->nip ?? '—'); ?></td>
                        ...
                        <td>
                            <div><?php echo e($g?->tempat_lahir ?? '—'); ?></div>
                            <?php if($g?->tanggal_lahir): ?>
                                <div style="color:#64748b;font-size:7pt;"><?php echo e($g->tanggal_lahir->format('d/m/Y')); ?></div>
                            <?php endif; ?>
                        </td>

                        <td><?php echo e($g?->pendidikan_terakhir ?? '—'); ?></td>

                        
                        <td>
                            <?php if($g?->status_pegawai): ?>
                                <?php
                                ...
                                ?>
                                <span class="badge <?php echo e($cls); ?>"><?php echo e($g->status_pegawai); ?></span>
                            <?php else: ?>
                                <span style="color:#cbd5e1;">—</span>
                            <?php endif; ?>
                        </td>

                        <td><?php echo e($g?->pangkat_gol_ruang ?? '—'); ?></td>
                        <td class="td-mono"><?php echo e($g?->no_sk_pertama ?? '—'); ?></td>
                        <td class="td-mono"><?php echo e($g?->no_sk_terakhir ?? '—'); ?></td>

                        
                        <td>
                            <?php if($g?->kelas?->nama): ?>
                                <span class="badge badge-kelas"><?php echo e($g->kelas->nama); ?></span>
                            <?php else: ?>
                                <span style="color:#cbd5e1;">—</span>
                            <?php endif; ?>
                        </td>
...
</html><?php /**PATH C:\PROJECT\smpn-kutime\resources\views/admin/pdf/guru.blade.php ENDPATH**/ ?>