<?php $__env->startSection('title', 'Kelola Website'); ?>

<?php $__env->startSection('content'); ?>
<div x-data="{ tab: '<?php echo e($tab ?? 'home'); ?>' }" class="min-h-screen" style="background:#f1f5f9">
    ...
    <div class="sticky top-0 z-30 bg-white border-b border-slate-200 shadow-sm">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-1 py-1 overflow-x-auto scrollbar-none">
                ...
                <?php $__currentLoopData = $tabItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button
                    @click="tab = '<?php echo e($t['key']); ?>'; history.replaceState(null,'','?tab=<?php echo e($t['key']); ?>')"
                    ...
                    :class="tab === '<?php echo e($t['key']); ?>'
                        ? 'bg-<?php echo e($t['color']); ?>-50 text-<?php echo e($t['color']); ?>-700 shadow-sm'
                        : 'text-slate-500 hover:text-slate-700 hover:bg-slate-50'">
                    <span><?php echo e($t['icon']); ?></span>
                    <?php echo e($t['label']); ?>
                    ...
                    <span class="ml-0.5 px-1.5 py-0.5 rounded-full text-xs font-bold"
                        ...
                        <?php echo e($beritaStats['total'] ?? 0); ?>

                    </span>
                    <?php elseif($t['key'] === 'galeri'): ?>
                    <span class="ml-0.5 px-1.5 py-0.5 rounded-full text-xs font-bold"
                          :class="tab === 'galeri' ? 'bg-violet-100 text-violet-700' : 'bg-slate-100 text-slate-500'">
                        <?php echo e($galeriStats['total'] ?? 0); ?>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        ...
        <div x-show="tab === 'home'" x-cloak class="space-y-4">
            ...
            <div class="flex flex-wrap gap-2 p-3 bg-white rounded-xl border border-slate-200 shadow-sm">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nav): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="#<?php echo e($nav['id']); ?>"
            ...
            <div id="sec-hero-media"
                 ...
                 x-data="heroAdmin('<?php echo e($hmTipe); ?>', <?php echo e($hmInterval); ?>)">
                ...
                <div class="flex items-center gap-2.5 px-5 py-3 bg-slate-50 border-b border-slate-100">
                    ...
                    <div class="ml-auto flex items-center gap-2">
                        <span class="px-2 py-0.5 text-xs font-medium rounded-full
                            <?php if($hmTipe==='none'): ?> bg-slate-100 text-slate-500
                            <?php elseif($hmTipe==='image'): ?> bg-blue-100 text-blue-700
                            <?php elseif($hmTipe==='video'): ?> bg-purple-100 text-purple-700
                            <?php elseif($hmTipe==='youtube'): ?> bg-red-100 text-red-700
                            <?php else: ?> bg-indigo-100 text-indigo-700 <?php endif; ?>">
                            <?php echo e(['none'=>'Warna Saja','image'=>'Gambar','video'=>'Video','youtube'=>'YouTube','slideshow'=>'Slideshow'][$hmTipe]); ?>

                        </span>
                    </div>
                </div>

                <form method="POST" action="<?php echo e(route('admin.kelola-website.update-hero-media')); ?>"
                    ...
                    <div class="grid grid-cols-5 gap-1.5">
                        <?php $__currentLoopData = ['none'=>['🚫','Tanpa Media'],'image'=>['🖼️','Gambar'],'video'=>['🎥','Video'],'youtube'=>['▶️','YouTube'],'slideshow'=>['🎞️','Slideshow']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>[$ico,$lbl]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex flex-col items-center gap-1 p-2.5 border-2 rounded-xl cursor-pointer transition-all"
                               :class="heroTipe==='<?php echo e($val); ?>' ? 'border-indigo-500 bg-indigo-50' : 'border-slate-200 hover:border-slate-300 bg-white'">
                            <input type="radio" value="<?php echo e($val); ?>" class="sr-only" x-model="heroTipe">
                            <span class="text-lg leading-none"><?php echo e($ico); ?></span>
                            <span class="text-xs leading-tight text-center"
                                  :class="heroTipe==='<?php echo e($val); ?>' ? 'text-indigo-700 font-semibold' : 'text-slate-500'"><?php echo e($lbl); ?></span>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <template x-if="heroTipe === 'image'">
                        <div class="space-y-2">
                            ...
                            <div class="relative rounded-xl overflow-hidden border border-slate-200" style="height:110px">
                                <img src="<?php echo e($hmFileUrls[0]); ?>" class="w-full h-full object-cover">
                            ...
                            <input type="hidden" name="keep_files[]" value="<?php echo e($hmFiles[0] ?? ''); ?>">
                            <?php endif; ?>
                    ...
                    <template x-if="heroTipe === 'video'">
                        <div class="space-y-2">
                            <?php if($hmTipe==='video' && !empty($hmFileUrls)): ?>
                            <div class="p-2 bg-slate-50 rounded-xl border border-slate-200">
                                <p class="text-xs text-slate-500 mb-1.5">Video saat ini:</p>
                                <video src="<?php echo e($hmFileUrls[0]); ?>" controls muted class="w-full rounded-lg" style="max-height:90px"></video>
                                <input type="hidden" name="keep_files[]" value="<?php echo e($hmFiles[0] ?? ''); ?>">
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="url" name="hero_media_link"
                                       value="<?php echo e($hmTipe==='youtube' ? $hmLink : ''); ?>"
                    ...
                    <template x-if="heroTipe === 'slideshow'">
                        <div class="space-y-2.5">
                            <?php if($hmTipe==='slideshow' && !empty($hmFiles)): ?>
                            <div class="p-3 bg-slate-50 rounded-xl border border-slate-200">
                                <p class="text-xs font-semibold text-slate-600 mb-2">Foto aktif — centang untuk pertahankan:</p>
                                <div class="grid grid-cols-5 gap-2">
                                    <?php $__currentLoopData = $hmFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $path): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative group">
                                        ...
                                        <label class="absolute inset-0 flex items-end justify-end p-1 cursor-pointer">
                                            <input type="checkbox" name="keep_files[]" value="<?php echo e($path); ?>" checked
                                                   class="w-4 h-4 rounded text-indigo-600 shadow">
                                        </label>
                                        <span class="absolute top-1 left-1 text-white text-xs bg-black/60 rounded px-1 leading-tight font-bold"><?php echo e($i+1); ?></span>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
            ...
            <div id="sec-teks-hero" class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <form method="POST" action="<?php echo e(route('admin.kelola-website.update-home')); ?>" class="p-5 space-y-3">
                    ...
                    <div class="grid sm:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="hero_title"
                                   value="<?php echo e(old('hero_title', $contents['hero_title']->value ?? 'SMP Negeri Kutime')); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="hero_description"
                                   value="<?php echo e(old('hero_description', $contents['hero_description']->value ?? '')); ?>"
                                   class="w-full rounded-xl border-slate-300 text-sm py-1.5 focus:border-indigo-500 focus:ring-indigo-500"
            ...
            <div id="sec-statistik" class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <form method="POST" action="<?php echo e(route('admin.kelola-website.update-stats')); ?>" class="p-5">
                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                        ...
                        <div class="p-3 rounded-xl border border-slate-200 bg-slate-50">
                            <label class="flex items-center gap-1.5 text-xs font-semibold text-slate-600 mb-1.5">
                                <span class="text-base"><?php echo e($s['icon']); ?></span><?php echo e($s['label']); ?>

                            </label>
                            <input type="text" name="<?php echo e($s['key']); ?>"
                                   value="<?php echo e(old($s['key'], $statsRow?->{$s['key']} ?? '')); ?>"
                                   class="w-full rounded-lg border-slate-300 text-sm py-1.5 focus:border-cyan-500 focus:ring-cyan-400 bg-white"
                                   placeholder="<?php echo e($s['ph']); ?>">
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div id="sec-tentang" class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <form method="POST" action="<?php echo e(route('admin.kelola-website.update-home')); ?>"
            ...
            <div id="sec-fasilitas" class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <form method="POST" action="<?php echo e(route('admin.kelola-website.update-home')); ?>" class="p-5">
                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                        <?php $__currentLoopData = [
                        ...
                        <div class="p-3 rounded-xl border border-slate-200 bg-slate-50">
                            <label class="flex items-center gap-1.5 text-xs font-semibold text-slate-600 mb-1.5">
                                <span><?php echo e($f['icon']); ?></span><?php echo e($f['label']); ?>

                            </label>
                            <input type="text" name="<?php echo e($f['key']); ?>"
                                   value="<?php echo e(old($f['key'], $contents[$f['key']]->value ?? '')); ?>"
            ...
            <div id="sec-sambutan" class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="mx-5 mt-4 flex items-center gap-3 p-3 bg-pink-50 rounded-xl border border-pink-100">
                    <img src="<?php echo e(asset('storage/'.$sambFotoPath)); ?>"
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-pink-400 truncate"><?php echo e(basename($sambFotoPath)); ?></p>
                    </div>
                    
                    <form method="POST"
                          action="<?php echo e(route('admin.kelola-website.delete-sambutan-foto')); ?>"
                ...
                <form method="POST" action="<?php echo e(route('admin.kelola-website.update-home')); ?>"
                      enctype="multipart/form-data" class="p-5 <?php echo e($sambFotoPath ? 'pt-3' : ''); ?>">
                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                        ...
                        <div class="space-y-2.5">
                            ...
                            <div>
                                ...
                                <input type="text" name="sambutan_nama"
                                       value="<?php echo e(old('sambutan_nama', $contents['sambutan_nama']->value ?? '')); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="sambutan_jabatan"
                                       value="<?php echo e(old('sambutan_jabatan', $contents['sambutan_jabatan']->value ?? 'Kepala Sekolah')); ?>"
                                       class="w-full rounded-xl border-slate-300 text-xs py-1.5 focus:border-pink-400 focus:ring-pink-300"
                            ...
                            <div>
                                ...
                                <textarea name="sambutan_teks" rows="4"
                                          ...
                                          placeholder="Isi sambutan singkat..."><?php echo e(old('sambutan_teks', $contents['sambutan_teks']->value ?? '')); ?></textarea>
                            </div>

                            
                            <div>
                                <label class="block text-xs text-slate-500 mb-1.5">
                                    <?php echo e($sambFotoPath ? 'Ganti Foto Kepala Sekolah' : 'Upload Foto Kepala Sekolah'); ?>
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <textarea name="info_ppdb" rows="4"
                                          ...
                                          placeholder="Informasi PPDB, syarat pendaftaran, jadwal, dll..."><?php echo e(old('info_ppdb', $contents['info_ppdb']->value ?? '')); ?></textarea>
                            </div>
                            <div>
                                <label class="block text-xs text-slate-500 mb-1">
                                    📅 Kalender Akademik
                                ...
                                <textarea name="info_kalender" rows="4"
                                          ...
                                          placeholder="Jadwal semester, ujian, libur, dll..."><?php echo e(old('info_kalender', $contents['info_kalender']->value ?? '')); ?></textarea>
                            </div>
                        </div>
                    </div>
        ...
        <div x-show="tab === 'identitas'" x-cloak class="space-y-4">
            ...
            <div class="bg-white rounded-xl border border-amber-200 shadow-sm overflow-hidden">
                ...
                <div class="p-5 flex items-center gap-4">
                    <div class="w-16 h-16 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center p-2 shrink-0">
                        <img src="<?php echo e($logoUrl); ?>" alt="Logo aktif" class="w-full h-full object-contain">
                    </div>
                    <div class="flex-1">
                    ...
                    <form method="POST"
                          action="<?php echo e(route('admin.kelola-website.delete-logo')); ?>"
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="flex items-center gap-2.5 px-5 py-3 bg-slate-50 border-b border-slate-100">
                    ...
                    <div>
                        <p class="text-xs font-semibold text-slate-800"><?php echo e($logoUrl ? 'Ganti Logo, Favicon & Identitas' : 'Upload Logo, Favicon & Identitas'); ?></p>
                        <p class="text-xs text-slate-400 mt-0.5">Tampil di navbar, footer, dan tab browser di seluruh halaman</p>
                    </div>
                </div>

                <form method="POST"
                      action="<?php echo e(route('admin.kelola-website.update-school-settings')); ?>"
                    ...
                    <div class="grid sm:grid-cols-2 gap-5">
                        ...
                        <div x-data="{ prev: null }" class="space-y-2">
                            <label class="block text-xs font-semibold text-slate-700">
                                <?php echo e($logoUrl ? 'Ganti Logo Sekolah' : 'Upload Logo Sekolah'); ?>
                            ...
                            <div class="flex items-center gap-2.5 p-2.5 bg-slate-50 rounded-xl border border-slate-200">
                                <img src="<?php echo e($logoUrl); ?>" class="h-8 w-8 object-contain rounded-lg bg-white p-0.5 border border-slate-200 shrink-0" alt="Logo saat ini">
                        ...
                        <div x-data="{ prev: null }" class="space-y-2">
                            ...
                            <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-200">
                                <div class="w-10 h-10 rounded-lg bg-white border border-slate-200 flex items-center justify-center p-1 shrink-0">
                                    <img src="<?php echo e($faviconUrl); ?>" alt="Favicon" class="w-full h-full object-contain">
                                </div>
                                <div class="flex-1">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="nama_sekolah"
                                   value="<?php echo e(old('nama_sekolah', $namaSekolah)); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="singkatan"
                                   value="<?php echo e(old('singkatan', $singkatan)); ?>"
                                   class="w-full rounded-xl border-slate-300 text-sm py-2 focus:border-amber-500 focus:ring-amber-400"
                    ...
                    <div>
                        ...
                        <textarea name="tagline_footer" rows="2"
                                  ...
                                  placeholder="Menyiapkan generasi unggul..."><?php echo e(old('tagline_footer', $taglineFooter)); ?></textarea>
        ...
        <div x-show="tab === 'kontak'" x-cloak class="space-y-4">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <form method="POST" action="<?php echo e(route('admin.kelola-website.update-kontak')); ?>" class="p-5 space-y-3">
                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                    ...
                    <div class="grid sm:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="kontak_telepon"
                                   value="<?php echo e(old('kontak_telepon', $kr?->kontak_telepon ?? '')); ?>"
                        ...
                        <div>
                            ...
                            <input type="email" name="kontak_email"
                                   value="<?php echo e(old('kontak_email', $kr?->kontak_email ?? '')); ?>"
                                   class="w-full rounded-xl border-slate-300 text-sm py-1.5 focus:border-teal-500 focus:ring-teal-400"
                    ...
                    <div>
                        ...
                        <textarea name="kontak_alamat" rows="2"
                                  ...
                                  placeholder="Jl. Pendidikan No. 1, Kelurahan ..., Kecamatan ..., Kab/Kota ..."><?php echo e(old('kontak_alamat', $kr?->kontak_alamat ?? '')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="kontak_maps_embed"
                               value="<?php echo e(old('kontak_maps_embed', $kr?->kontak_maps_embed ?? '')); ?>"
                               class="w-full rounded-xl border-slate-300 text-sm py-1.5 focus:border-teal-500 focus:ring-teal-400"
                    ...
                    <div class="grid sm:grid-cols-2 gap-3">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <label class="block text-xs font-semibold text-slate-600 mb-1"><?php echo e($sm['icon']); ?> <?php echo e($sm['label']); ?></label>
                            <input type="url" name="<?php echo e($sm['key']); ?>"
                                   value="<?php echo e(old($sm['key'], $kr?->{$sm['key']} ?? '')); ?>"
                                   class="w-full rounded-xl border-slate-300 text-sm py-1.5 focus:border-teal-500 focus:ring-teal-400"
                                   placeholder="<?php echo e($sm['ph']); ?>">
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="flex items-center justify-between bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
                ...
                <a href="<?php echo e(route('website.home')); ?>#kontak" target="_blank"
                   class="inline-flex items-center gap-1.5 px-4 py-2 bg-emerald-600 text-white text-xs font-semibold rounded-xl hover:bg-emerald-700 transition shadow-sm whitespace-nowrap">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                    </svg>
        ...
        <div x-show="tab === 'berita'" x-cloak>
            <?php echo $__env->make('admin.kelola-website.tabs.berita', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        
        <div x-show="tab === 'galeri'" x-cloak>
            <?php echo $__env->make('admin.kelola-website.tabs.galeri', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
(function initQuill() {
    ...
    function setupEditors() {
        const savedTentang = <?php echo json_encode($valTentang ?? '', 15, 512) ?>;
        const savedVisi    = <?php echo json_encode($valVisi    ?? '', 15, 512) ?>;
        const savedMisi    = <?php echo json_encode($valMisi    ?? '', 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PROJECT\smpn-kutime\resources\views/admin/kelola-website/tabs/home.blade.php ENDPATH**/ ?>