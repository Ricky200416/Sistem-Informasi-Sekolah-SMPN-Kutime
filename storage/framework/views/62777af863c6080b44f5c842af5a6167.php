...
<div id="absensiApp" class="space-y-4"
     data-sudah-absen-masuk="<?php echo e($absensiHariIni ? 'true' : 'false'); ?>"
     data-sudah-absen-pulang="<?php echo e(($absensiHariIni && $absensiHariIni->foto_pulang) ? 'true' : 'false'); ?>"
     data-tipe-absen="<?php echo e($absensiHariIni->tipe_absensi ?? ''); ?>"
     data-sekolah-lat="<?php echo e($lokasiSekolah['latitude']); ?>"
     data-sekolah-lng="<?php echo e($lokasiSekolah['longitude']); ?>"
     data-sekolah-radius="<?php echo e($lokasiSekolah['radius']); ?>"
     data-url-masuk="<?php echo e(route('guru.absensi-foto.masuk')); ?>"
     data-url-pulang="<?php echo e(route('guru.absensi-foto.pulang')); ?>">
    ...
    <div id="stepHome" class="wizard-step">
        ...
        <div class="af-hero">
            ...
            <div class="af-hero-top">
                <div>
                    <p class="af-hero-greet"><?php echo e($sapaan); ?> <?php echo e($emoji); ?></p>
                    <p class="af-hero-name"><?php echo e(Auth::user()->name); ?></p>
                    <p class="af-hero-date"><?php echo e($hariIniNama); ?>, <?php echo e(now()->translatedFormat('d F Y')); ?></p>
                </div>
            ...
            <div class="af-stats-row">
                <div class="af-stat-chip">
                    <div class="v"><?php echo e($totalHadir); ?></div>
                    <div class="l">Hadir Terakhir</div>
                </div>
                <div class="af-stat-chip">
                    <div class="v"><?php echo e($totalTerlambat); ?></div>
                    <div class="l">Terlambat</div>
                </div>
                <div class="af-stat-chip">
                    <div class="v"><?php echo e($jadwalHariIni->count()); ?></div>
        ...
        <div class="af-card p-4">
            ...
            <?php elseif($absensiHariIni->tipe_absensi === 'mengajar' && !$absensiHariIni->foto_pulang): ?>
                <div class="af-status-card af-status-progress" style="margin-top:0;">
                    ...
                    <div class="af-mini-row" style="margin-top:0;margin-bottom:.7rem;">
                        <span class="af-mini-pill">⏰ <?php echo e(substr($absensiHariIni->jam_masuk,0,5)); ?> WIB</span>
                        <span class="af-mini-pill"><?php echo e($absensiHariIni->status === 'L' ? '🐢 Terlambat' : '✅ Hadir'); ?></span>
                        <span class="af-mini-pill">📍 <?php echo e($absensiHariIni->jarak_masuk); ?> m</span>
                    </div>
            ...
            <?php else: ?>
                <div class="af-status-card af-status-done" style="margin-top:0;">
                    ...
                    <div class="af-mini-row" style="margin-top:0;">
                        <span class="af-mini-pill">Masuk <?php echo e(substr($absensiHariIni->jam_masuk,0,5)); ?></span>
                        <?php if($absensiHariIni->jam_pulang): ?>
                        <span class="af-mini-pill">Pulang <?php echo e(substr($absensiHariIni->jam_pulang,0,5)); ?></span>
                        <?php endif; ?>
                        <span class="af-mini-pill"><?php echo e($absensiHariIni->status === 'L' ? 'Terlambat' : 'Hadir'); ?></span>
                    </div>
            ...
            <div class="mt-4">
                ...
                <div>
                    ...
                    <?php $warna = $jadwal->studySubject->color ?? '#6366f1'; ?>
                    <div class="af-timeline-item">
                        <div class="af-timeline-dot" style="background: <?php echo e($warna); ?>;">
                            <?php echo e(substr($jadwal->start_time,0,2)); ?>
                        ...
                        <div class="flex-1 min-w-0 pt-0.5">
                            ...
                            <p class="text-[10px] text-slate-400">
                                ...
                                &nbsp;·&nbsp; <i class="bi bi-mortarboard"></i> <?php echo e($jadwal->studyGroup->name ?? '—'); ?>
        ...
        <div id="blokRiwayat" class="hidden mt-3 af-card overflow-hidden">
            <div class="px-4 py-3 border-b border-slate-100 dark:border-slate-700 flex items-center justify-between">
                ...
                <span class="text-[10px] text-slate-400"><?php echo e($totalRiwayat); ?> data terakhir</span>
            </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $riwayat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center gap-3 px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-700/20 transition">
                        <img src="<?php echo e(Storage::url($r->foto_masuk)); ?>"
                             class="w-11 h-11 rounded-xl object-cover border-2 <?php echo e($r->status === 'L' ? 'border-amber-300' : 'border-emerald-300'); ?>">
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-[10px] text-slate-400">
                                <?php echo e($r->tipe_absensi === 'kantor' ? '🏢 Kantor' : '📚 Mengajar'); ?>

                                · Masuk <?php echo e(substr($r->jam_masuk,0,5)); ?>

                                <?php if($r->jam_pulang): ?> · Pulang <?php echo e(substr($r->jam_pulang,0,5)); ?> <?php endif; ?>
                                <?php if($r->jarak_masuk !== null): ?> · <?php echo e($r->jarak_masuk); ?>m <?php endif; ?>
                            </p>
                        </div>
                        <span class="text-[10px] font-bold px-2.5 py-1 rounded-full <?php echo e($r->status === 'L' ? 'bg-amber-100 text-amber-700' : 'bg-emerald-100 text-emerald-700'); ?>">
                            <?php echo e($r->status === 'L' ? 'Terlambat' : 'Hadir'); ?>
            ...
            <div class="mb-3">
                ...
                <div class="space-y-1.5 max-h-44 overflow-y-auto pr-1">
                    ...
                    <label class="af-mode-card flex items-center gap-2.5 cursor-pointer">
                        <input type="radio" name="pilihJadwal" value="<?php echo e($jadwal->id); ?>" class="radioJadwal w-3.5 h-3.5 text-indigo-600">
                        <span class="w-2 h-8 rounded-full shrink-0" style="background: <?php echo e($jadwal->studySubject->color ?? '#6366f1'); ?>"></span>
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-[9.5px] text-slate-400"><i class="bi bi-clock"></i> <?php echo e(substr($jadwal->start_time,0,5)); ?>–<?php echo e(substr($jadwal->end_time,0,5)); ?></p>
                        </div>
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <div id="stepKonfirmasiAbsensi" class="wizard-step hidden">
        <div class="af-card p-4">
            ...
            <div class="af-ticket mb-3">
                <div class="af-ticket-row"><span>Nama</span><strong><?php echo e(Auth::user()->name); ?></strong></div>
                <div class="af-ticket-row"><span>Tanggal</span><strong><?php echo e(now()->translatedFormat('d F Y')); ?></strong></div>
