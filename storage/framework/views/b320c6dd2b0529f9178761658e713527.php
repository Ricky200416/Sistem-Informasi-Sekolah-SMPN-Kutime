            ...
            <div class="grid sm:grid-cols-2 gap-5">
                ...
                <div x-data="{ prev: null }" class="space-y-2">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-200">
                        <img src="<?php echo e($logoUrl); ?>" alt="Logo saat ini" class="h-12 w-12 object-contain rounded-lg bg-white p-1 border border-slate-200">
                        <div>
                ...
                <div x-data="{ prev: null }" class="space-y-2">
                    ...
                    <?php if($faviconUrl): ?>
                    <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-200">
                        <img src="<?php echo e($faviconUrl); ?>" alt="Favicon saat ini" class="h-8 w-8 object-contain rounded border border-slate-200 bg-white p-0.5">
                        <div>
...
</div><?php /**PATH C:\PROJECT\smpn-kutime\resources\views/admin/kelola-website/tabs/identitas.blade.php ENDPATH**/ ?>