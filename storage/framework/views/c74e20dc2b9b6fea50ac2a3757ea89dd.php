    ...
    <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            ...
            <p style="font-size:.7rem;color:#c4b5fd;margin-top:4px;">
                ...
                <?php if(isset($isWaliKelas) && $isWaliKelas && isset($namaKelasWali)): ?>
                    &nbsp;·&nbsp; Wali Kelas <strong style="color:#fff;"><?php echo e($namaKelasWali); ?></strong>
                <?php endif; ?>
            </p>
        </div>
        ...
        <div class="flex items-center gap-3 shrink-0">
            ...
            <div class="rounded-xl px-4 py-3 text-center border bg-white/15 border-white/20">
                <p style="font-size:1.1rem;font-weight:800;line-height:1;color:#fff;"><?php echo e(now()->format('d')); ?></p>
                <p style="font-size:.55rem;color:#c4b5fd;margin-top:3px;"><?php echo e(now()->isoFormat('MMM Y')); ?></p>
            </div>
        </div>
    </div>
</div>
...
</script><?php /**PATH C:\PROJECT\smpn-kutime\resources\views/guru/dashboard/header.blade.php ENDPATH**/ ?>