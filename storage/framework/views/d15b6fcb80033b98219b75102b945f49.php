...
<div class="max-w-4xl mx-auto px-4 py-6" x-data="{ openEdit: false }">
        ...
        <div class="md:col-span-1 space-y-6">
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 text-center">
                <div class="relative inline-block mb-4">
                    <?php if($user->photo): ?>
                        <img src="<?php echo e(Storage::url($user->photo)); ?>" alt="Avatar"
                ...
                <h3 class="text-sm font-bold text-slate-800 dark:text-slate-100 truncate"><?php echo e($user->name); ?></h3>
                <p class="text-xs text-slate-400 dark:text-slate-500 mb-3 truncate"><?php echo e($user->email); ?></p>
                ...
                <div class="border-t border-slate-100 dark:border-slate-700/50 my-4 pt-4 text-left space-y-2">
                    ...
                    <div class="flex justify-between items-center text-xs">
                        ...
                        <span class="font-medium text-slate-700 dark:text-slate-300"><?php echo e($user->created_at ? $user->created_at->format('d M Y') : '07 Jun 2026'); ?></span>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start gap-3 text-xs">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400">Hari ini, <?php echo e(date('H:i')); ?> WIB • IP: 192.168.1.1</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="editProfilModal" 
        ...
        <div class="bg-white dark:bg-slate-800 w-full max-w-2xl rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 transform transition-all overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <form action="<?php echo e(route('admin.profil.update')); ?>" method="POST" enctype="multipart/form-data" class="flex-1 overflow-y-auto p-6 space-y-5">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4 bg-slate-50 dark:bg-slate-900/30 p-3 rounded-xl border border-dashed border-slate-200 dark:border-slate-700">
                        <?php if($user->photo): ?>
                            <img src="<?php echo e(Storage::url($user->photo)); ?>" alt="Preview"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PROJECT\smpn-kutime\resources\views/admin/profil.blade.php ENDPATH**/ ?>