        ...
        <div class="relative px-7 py-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-3 flex-shrink-0">
                ...
                <div class="rounded-2xl px-4 py-2.5 text-center border"
                    ...
                    <p class="text-sky-200 text-xs font-medium mt-0.5"><?php echo e(now()->isoFormat('Y')); ?></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <button type="button"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <?php if($item->tanggal_selesai && !$segBerakhir): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PROJECT\smpn-kutime\resources\views/siswa/pengumuman/index.blade.php ENDPATH**/ ?>