...
<div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200
        ...
        <div class="flex items-center gap-2.5">
            ...
            <div>
                ...
                <p class="text-[10px] text-slate-400 leading-none mt-0.5">
                    <?php echo e($widgetPengumuman->count()); ?> terbaru
                </p>
            </div>
        </div>
    ...
    <div class="divide-y divide-slate-100 dark:divide-slate-700/50">
        ...
        <button type="button"
                onclick='annOpen(<?php echo e($annJson); ?>)'
            ...
            <div class="flex items-start gap-3 px-4 py-3.5">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <?php if($item->isi && $tipeKonten === 'teks'): ?>
                    ...
                    <?php if($tipeKonten === 'link' && $linkUrl): ?>
                    <div class="inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded-md
...
<?php if (! $__env->hasRenderedOnce('d3280e18-f547-4564-8f6c-3c9e42f68c2b')): $__env->markAsRenderedOnce('d3280e18-f547-4564-8f6c-3c9e42f68c2b'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH C:\PROJECT\smpn-kutime\resources\views/siswa/dashboard/announcement.blade.php ENDPATH**/ ?>